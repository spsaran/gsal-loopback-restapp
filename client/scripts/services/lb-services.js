...
/**
 * @ngdoc object
 * @name lbServices.Items
 * @header lbServices.Items
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Items` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Items.customers.findById() instead.
        "prototype$__findById__customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/items/:id/customers/:fk",
          method: "GET"
        },

        // INTERNAL. Use Items.customers.destroyById() instead.
        ...
        // INTERNAL. Use Items.customers.updateById() instead.
        ...
        // INTERNAL. Use Items.comments.findById() instead.
        ...
        // INTERNAL. Use Items.comments.destroyById() instead.
        ...
        // INTERNAL. Use Items.comments.updateById() instead.
        ...
        // INTERNAL. Use Items.favorites.findById() instead.
        "prototype$__findById__favorites": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/items/:id/favorites/:fk",
          method: "GET"
        },

        // INTERNAL. Use Items.favorites.destroyById() instead.
        ...
        // INTERNAL. Use Items.favorites.updateById() instead.
        ...
        // INTERNAL. Use Items.customers() instead.
        "prototype$__get__customers": {
          isArray: true,
          url: urlBase + "/items/:id/customers",
          method: "GET"
        },

        // INTERNAL. Use Items.customers.create() instead.
        "prototype$__create__customers": {
          url: urlBase + "/items/:id/customers",
          method: "POST"
        },

        // INTERNAL. Use Items.customers.destroyAll() instead.
        "prototype$__delete__customers": {
          url: urlBase + "/items/:id/customers",
          method: "DELETE"
        },

        // INTERNAL. Use Items.customers.count() instead.
        "prototype$__count__customers": {
          url: urlBase + "/items/:id/customers/count",
          method: "GET"
        },

        // INTERNAL. Use Items.comments() instead.
        ...
        // INTERNAL. Use Items.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/items/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Items.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/items/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Items.comments.count() instead.
        "prototype$__count__comments": {
          url: urlBase + "/items/:id/comments/count",
          method: "GET"
        },

        // INTERNAL. Use Items.favorites() instead.
        "prototype$__get__favorites": {
          isArray: true,
          url: urlBase + "/items/:id/favorites",
          method: "GET"
        },

        // INTERNAL. Use Items.favorites.create() instead.
        "prototype$__create__favorites": {
          url: urlBase + "/items/:id/favorites",
          method: "POST"
        },

        // INTERNAL. Use Items.favorites.destroyAll() instead.
        "prototype$__delete__favorites": {
          url: urlBase + "/items/:id/favorites",
          method: "DELETE"
        },

        // INTERNAL. Use Items.favorites.count() instead.
        "prototype$__count__favorites": {
          url: urlBase + "/items/:id/favorites/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Items#create
         * @methodOf lbServices.Items
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Items` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/items",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#createMany
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#findById
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#updateAll
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#deleteById
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#prototype$updateAttributes
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#createChangeStream
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        // INTERNAL. Use Comments.items() instead.
        "::get::Comments::items": {
          url: urlBase + "/Comments/:id/items",
          method: "GET"
        },

        // INTERNAL. Use Favorites.items() instead.
        "::get::Favorites::items": {
          url: urlBase + "/Favorites/:id/items",
          method: "GET"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#updateOrCreate
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#destroyById
         * @methodOf lbServices.Items
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Items#removeById
         * @methodOf lbServices.Items
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Items#modelName
    * @propertyOf lbServices.Items
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Items`.
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Items.customers
     * @header lbServices.Items.customers
     * @object
     * @description
     *
     * The object `Items.customers` groups methods
     * manipulating `Customer` instances related to `Items`.
     *
     * Call {@link lbServices.Items#customers Items.customers()}
     ...
     */
        ...
        R.customers = function() {
          ...
          var action = TargetResource["::get::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#count
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
         * Counts customers of items.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.customers.count = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::count::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#create
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
        ...
        R.customers.create = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::create::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#createMany
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
        ...
        R.customers.createMany = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::createMany::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#destroyAll
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
        ...
        R.customers.destroyAll = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::delete::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#destroyById
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
        ...
        R.customers.destroyById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::destroyById::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#findById
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
        ...
        R.customers.findById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::findById::items::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.customers#updateById
         * @methodOf lbServices.Items.customers
         *
         * @description
         *
        ...
        R.customers.updateById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::updateById::items::customers"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Items.comments
     * @header lbServices.Items.comments
     * @object
     * @description
     *
     * The object `Items.comments` groups methods
     * manipulating `Comments` instances related to `Items`.
     *
     * Call {@link lbServices.Items#comments Items.comments()}
     * to query all related instances.
     */
        ...
        R.comments = function() {
          ...
          var action = TargetResource["::get::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#count
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
         * Counts comments of items.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::count::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#create
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::create::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#createMany
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::createMany::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#destroyAll
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::delete::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#destroyById
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::destroyById::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#findById
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::findById::items::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.comments#updateById
         * @methodOf lbServices.Items.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::updateById::items::comments"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Items.favorites
     * @header lbServices.Items.favorites
     * @object
     * @description
     *
     * The object `Items.favorites` groups methods
     * manipulating `Favorites` instances related to `Items`.
     *
     * Call {@link lbServices.Items#favorites Items.favorites()}
     * to query all related instances.
     */
        ...
        R.favorites = function() {
          ...
          var action = TargetResource["::get::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#count
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
         * Counts favorites of items.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.favorites.count = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::count::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#create
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
        ...
        R.favorites.create = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::create::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#createMany
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
        ...
        R.favorites.createMany = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::createMany::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#destroyAll
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
        ...
        R.favorites.destroyAll = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::delete::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#destroyById
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
        ...
        R.favorites.destroyById = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::destroyById::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#findById
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
        ...
        R.favorites.findById = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::findById::items::favorites"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Items.favorites#updateById
         * @methodOf lbServices.Items.favorites
         *
         * @description
         *
        ...
        R.favorites.updateById = function() {
          var TargetResource = $injector.get("Favorites");
          var action = TargetResource["::updateById::items::favorites"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Items.customers.createMany() instead.
        "::createMany::items::customers": {
          isArray: true,
          url: urlBase + "/items/:id/customers",
          method: "POST"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Items.comments.createMany() instead.
        "::createMany::items::comments": {
          isArray: true,
          url: urlBase + "/items/:id/comments",
          method: "POST"
        },
    ...
    */
    R.modelName = "Comments";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Comments#items
         * @methodOf lbServices.Comments
         *
         * @description
         *
         ...
         */
        R.items = function() {
          var TargetResource = $injector.get("Items");
          var action = TargetResource["::get::Comments::items"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Items.favorites.create() instead.
        "::create::items::favorites": {
          url: urlBase + "/items/:id/favorites",
          method: "POST"
        },

        // INTERNAL. Use Items.favorites.createMany() instead.
        "::createMany::items::favorites": {
          isArray: true,
          url: urlBase + "/items/:id/favorites",
          method: "POST"
        },
    ...
    */
    R.modelName = "Favorites";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Favorites#items
         * @methodOf lbServices.Favorites
         *
         * @description
         *
        ...
        R.items = function() {
          var TargetResource = $injector.get("Items");
          var action = TargetResource["::get::Favorites::items"];
          return action.apply(R, arguments);
        };
